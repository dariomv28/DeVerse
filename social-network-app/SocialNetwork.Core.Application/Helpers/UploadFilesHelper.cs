...
namespace SocialNetwork.Core.Application.Helpers
{
    ...
    {
        public static string UploadFile(IFormFile file, string id, string entity = "Users", bool isEditMode = false, string imagePath = "")
        {
        ...
        public static void DeleteFile(int id, string entity = "Posts")
        {
            //get directory path
            string basePath = $"/Images/{entity}/{id}";
            string path = Path.Combine(Directory.GetCurrentDirectory(), $"wwwroot{basePath}");
