    ...
    public class GeneralProfile : Profile
    {
        public GeneralProfile()
        {
            ...
            CreateMap<Post, PostViewModel>()
                ...
                .ForMember(x => x.SharedPostUserId, opt => opt.Ignore())
                .ForMember(x => x.SharedPostUserName, opt => opt.Ignore())
                .ForMember(x => x.SharedPostUserProfilePicture, opt => opt.Ignore())
                .ForMember(x => x.SharedPostCreated, opt => opt.Ignore())
                .ReverseMap()
                .ForMember(x => x.SharedPost, opt => opt.Ignore())
                .ForMember(x => x.SharedByPosts, opt => opt.Ignore())
